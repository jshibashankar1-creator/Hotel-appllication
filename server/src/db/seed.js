    ...
    data.hotels = [
      {
        ...
        hotel_type: 'Luxury Business & Leisure',
        description: 'Ultra-luxury 5-star hotel located in the heart of BKC Mumbai with world-class fine dining, skyline infinity pool, and premium executive suites.',
        ...
        amenities: ['High-speed Wi-Fi', 'Infinity Pool', 'Luxury Spa', 'Fine Dining Restaurant', '24/7 Room Service', 'Valet Parking', 'Fitness Center', 'Airport Shuttle'],
      ...
      },
      {
        ...
        description: 'A 200-year-old restored Rajput palace offering authentic royal hospitality, regal courtyards, Ayurvedic wellness, and handcrafted luxury.',
        ...
        amenities: ['Royal Courtyard', 'Ayurvedic Spa', 'Outdoor Pool', 'Folk Music Evenings', 'Complimentary Breakfast', 'Heritage Architecture', 'Concierge Service'],
      ...
      },
      {
        ...
        description: 'Vibrant beachfront resort steps away from Calangute sands with sun decks, poolside cocktails, and authentic Goan seafood dining.',
        address: 'Calangute Beach Road, North Goa',
        city: 'Goa',
        state: 'Goa',
        country: 'India',
        ...
        amenities: ['Direct Beach Access', 'Beachfront Bar', 'Swimming Pool', 'Water Sports Desk', 'Free Wi-Fi', 'Complimentary Breakfast'],
      ...
      },
      {
        ...
        name: 'The Imperial Suites New Delhi',
        hotel_type: 'Boutique Executive',
        description: 'Centrally located luxury boutique suites in Connaught Place, blending Victorian colonial charm with modern 5-star executive amenities.',
